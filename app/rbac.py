...
PERMISSIONS = {
    "admin": {
        ...
        "delivery_manage",
        "delivery_approve",
        "partner_registry_read",
        "partner_registry_manage",
        "partner_registry_approve",
        "procurement_read",
        "procurement_manage",
        "procurement_approve",
        "supplier_contract_read",
        "supplier_contract_manage",
        "supplier_contract_approve",
        "portfolio_read",
        "portfolio_manage",
        "capacity_read",
        "capacity_manage",
