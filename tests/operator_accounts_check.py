...
class OperatorAccountsCheck(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        init_supplier_contracts(cls.app, app_module)
    ...
    def test_admin_can_download_operational_excel(self):
        ...
        self.assertIn("Consegne", workbook.sheetnames)
        self.assertIn("Controlli consegna", workbook.sheetnames)
        self.assertIn("Difetti post-consegna", workbook.sheetnames)
        self.assertIn("Storico consegne", workbook.sheetnames)
        ...
        self.assertIn("Contratti fornitori", workbook.sheetnames)
        self.assertIn("Milestone contratti", workbook.sheetnames)
        self.assertIn("Documenti contratti", workbook.sheetnames)
        self.assertIn("Varianti contratti", workbook.sheetnames)
        self.assertIn("Storico contratti", workbook.sheetnames)
        ...
        self.assertIn("Richieste preventivo", workbook.sheetnames)
        self.assertIn("Storico preventivi", workbook.sheetnames)
